...
It involves mounting the file system onto a Linux Operating system as it nativly should support the required needed formats allowing for making the necessary changes before re-uploading it to the device. 
